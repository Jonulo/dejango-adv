# Generated by Django 2.0.9 on 2020-09-12 23:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_limited', models.BooleanField(default=False, help_text='Limited circles can grow up to fixed numbers of members', verbose_name='limited')),
                ('members_limit', models.PositiveIntegerField(default=True, help_text='If circle is limited, this will be the limit on the numbers of members')),
            ],
            options={
